...
export const metadata: Metadata = {
  ...
  description: "A complete, free DSA interview preparation guide. 120 curated problems, 29 deep-dive chapters, crash-course plans, and built-in progress tracking. No paywall, no login.",
  keywords: ["DSA", "interview preparation", "LeetCode", "coding interview", "data structures", "algorithms", "FAANG", "placement preparation", "competitive programming"],
  ...
  openGraph: {
    ...
    description: "120 curated problems, 29 chapters, crash-course plans, and progress tracking. Free. No login required.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
